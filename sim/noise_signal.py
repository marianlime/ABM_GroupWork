...
def assign_noise_parameter_set(n_agents, noise_parameter_distribution_type, distribution_data):
    if noise_parameter_distribution_type == "uniform": 
        return np.random.uniform(distribution_data["low"],
        ...
        group_a = np.random.normal(distribution_data["group_a_mean"],
                                   distribution_data["group_a_std"],
                                   n_a) 

        group_b = np.random.normal(distribution_data["group_b_mean"],
        ...
        return np.random.lognormal(mean=distribution_data["mean"],
