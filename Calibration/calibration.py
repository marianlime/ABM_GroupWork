...
CAL_RESULTS_PATH = CALIBRATION_DIR / "calibration_results.csv"
CAL_SUMMARY_PATH = CALIBRATION_DIR / "calibration_summary.txt"
...
CAL_ROUNDS      = 25
CAL_SEED        = 42
CAL_DB_PATH     = str(CALIBRATION_DIR / "calibration_temp.duckdb")
...
def main():
    ...
    # Save outputs
    df3.to_csv(CAL_RESULTS_PATH, index=False)
    ...
    print(f"\n  Saved: {CAL_RESULTS_PATH}  |  {CAL_SUMMARY_PATH}\n")
