...
# ZI agents have no strategy function — their orders are generated in bulk
# by Game._batch_zi_orders (vectorised, seeded, correct price anchor).
# There are no unit tests here for ZI order logic; see game.py for the
...
class TestParameterisedInformed(unittest.TestCase):
    ...
    def test_higher_qty_aggression_higher_fraction(self):
