...
def test_signal_generator_lognormal_positive():
    ...
    out = signal_generator(0.2, 100.0, bias=0.0, signal_generator_noise_distribution="lognormal")
...
def test_signal_generator_uniform_range():
    ...
    S_next = 100.0
    sigma = 0.2
    out = signal_generator(sigma, S_next,bias=0.0, signal_generator_noise_distribution="uniform")
...
def test_signal_generator_invalid_distribution_raises():
    ...
    with pytest.raises(ValueError):
        signal_generator(0.2, 100.0,bias=0.0, signal_generator_noise_distribution="bad_dist")


def test_signal_generator_reproducible_with_seed():
    # Fix random seed for reproducibility
    np.random.seed(42)
    x1 = signal_generator(0.2, 100.0,bias=0.0, signal_generator_noise_distribution="lognormal")

    # Reset seed and generate again
    np.random.seed(42)
    x2 = signal_generator(0.2, 100.0,bias=0.0, signal_generator_noise_distribution="lognormal")
...
def test_signal_generator_uniform_zero_noise():
    ...
    out = signal_generator(0.0, 100.0,bias=0.0, signal_generator_noise_distribution="uniform")
...
def test_signal_generator_lognormal_zero_noise_zero_bias():
    ...
    out = signal_generator(0.0, 100.0, bias=0.0, signal_generator_noise_distribution="lognormal")
...
def test_signal_generator_lognormal_zero_noise_with_bias():
    ...
    out = signal_generator(0.0, 100.0, bias=0.1, signal_generator_noise_distribution="lognormal")
...
def test_assign_noise_bimodal_odd_num_agents():
    ...
    arr = assign_noise_parameter_set(7, "bimodal", {"group_a_mean":0.2, "group_a_std":0.05, "group_b_mean":0.8, "group_b_std":0.05},)
