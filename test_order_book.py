...
test_order_book.py
==================
Unit tests for the order_book module.

Run with:
    pytest test_order_book.py -v
"""
...
# ---------------------------------------------------------------------------
# No-match (spread too wide — no overlap)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Edge cases — empty / one-sided input
# ---------------------------------------------------------------------------
